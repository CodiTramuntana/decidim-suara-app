  ...
  module Consultations
    module Admin
      ...
      class QuestionForm < Form
        ...
        # Suara customization: remove presence validation in this fields except title
        validates :title, presence: true
        validates :promoter_group, :participatory_scope, :subtitle, :what_is_decided, translatable_presence: false
        # Suara customization
