...
Deface::Override.new(virtual_path: 'decidim/consultations/admin/responses/_form',
                     ...
                     text: "
                        <% if current_question.blank_vote %>
                          ...
                          { data: Hash[*current_question.organization.available_locales.map{|locale| [locale, I18n.with_locale(locale.to_sym) { t('activemodel.attributes.response.blank_vote') }] }.flatten] }.to_json %>
                        <% end %>
                     ")
