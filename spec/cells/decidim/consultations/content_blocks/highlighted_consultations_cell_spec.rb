  ...
  module Consultations
    module ContentBlocks
      describe HighlightedConsultationsCell, type: :cell do
        ...
        let!(:consultation_with_filter) { create(:consultation, :active, organization:, suara_permissions: { ceco: "ceco", ceco_txt: "ceco_txt" }) }
        let!(:consultation_with_other_filter) { create(:consultation, :active, organization:, suara_permissions: { ceco: "a", ceco_txt: "b" }) }
        let!(:consultation_without_filter) { create(:consultation, :active, organization:, suara_permissions: { ceco: "", ceco_txt: "" }) }
